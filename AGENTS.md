...
- `docs/dev/KERNEL_TRIALS.md`: default local PocketFed kernel/userspace trials, kboop integration, and USB/resident-root boundaries. Read before planning device trials or routing them through public builds.
